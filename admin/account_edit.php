        ...
        ?>
                <form action="account_edit.php?id=<?php echo $result_account["id"]; ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" id="dateofbirth" name="dateofbirth" required value="<?php echo $fm->formatDateReverse($result_account["date_birth"]) ?>">
                    </div>

                    <div class="form-group">
                        <label for="place-of-birth">Place of Birth</label>
                        <input type="text" id="placeofbirth" name="placeofbirth" required value="<?php echo $result_account["place_of_birth"] ?>">
                    </div>
                        ...
                        <select id="permission" name="permission" required>
                            ...
                            if ($show_permission) {
                                while ($result = $show_permission->fetch_assoc()) {
                                    if ($result["id"] == $result_account["permission_id"]) {
                                        $permisson = "selected";
                            ?>
                                        <option value="<?php echo $result["id"]; ?>" <?php echo $permisson ?>><?php echo $result["name"] ?></option>
                                    <?php
                                    } else { ?>
                    ...
                    <div class="form-group">
                        ...
                        <select id="status" name="status" required>
                            ...
                            <option value="0" <?php echo $status_0?>>Ngừng hoạt động</option>
                            <option value="1" <?php echo $status_1?>>Đang hoạt động</option>
                        </select>
                    </div>
